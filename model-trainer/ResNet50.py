...
img_height, img_width = 224, 224  # ResNet50 uses 224x224 images
batch_size = 32
epochs = 10
...
model.save('resnet50_lumpy_skin.h5')
...
def predict_image(image_path, model_path='resnet50_lumpy_skin.h5'):
